...
RBAC_TEST_MATRIX = [
    ("SYS_ADMIN", "/api/orgs", "GET", 200, "dashboard:view", "ALLOW", "系统管理员可查看组织列表"),
    ("SYS_ADMIN", "/api/tools/search", "GET", 200, "tool:search", "ALLOW", "系统管理员可搜索工装"),
    ("SYS_ADMIN", "/api/tools/status-history/T000001", "GET", 200, "tool:view", "ALLOW", "系统管理员可查看工装状态历史"),
    ("SYS_ADMIN", "/api/notifications", "GET", 200, "notification:view", "ALLOW", "系统管理员可查看通知列表"),
    ("SYS_ADMIN", "/api/tool-io-orders/TEST001/generate-transport-text", "GET", 404, "notification:create", "ALLOW", "系统管理员可生成运输通知文案"),
    ("SYS_ADMIN", "/api/tool-io-orders/TEST001/notify-transport", "POST", 404, "notification:send_feishu", "ALLOW", "系统管理员可发送运输通知"),
    ("SYS_ADMIN", "/api/logs", "GET", 404, "log:view", "ALLOW", "系统管理员具备日志查看权限但当前路由缺失"),
    ("SYS_ADMIN", "/api/admin/roles", "GET", 200, "admin:role_manage", "ALLOW", "系统管理员可查看角色列表"),
    ("SYS_ADMIN", "/api/admin/users", "GET", 200, "admin:user_manage", "ALLOW", "系统管理员可查看用户列表"),
    ("SYS_ADMIN", "/api/tool-io-orders", "GET", 200, "order:list", "ALLOW", "系统管理员可查看订单列表"),
    ("SYS_ADMIN", "/api/tool-io-orders", "POST", 400, "order:create", "ALLOW", "系统管理员通过权限校验后会进入创建参数校验"),
    ("SYS_ADMIN", "/api/tool-io-orders/TEST001/submit", "POST", 404, "order:submit", "ALLOW", "系统管理员可提交订单"),
    ("SYS_ADMIN", "/api/tool-io-orders/TEST001/keeper-confirm", "POST", 400, "order:keeper_confirm", "ALLOW", "系统管理员执行保管员确认但空body返回验证错误"),
    ("SYS_ADMIN", "/api/tool-io-orders/TEST001/final-confirm", "POST", 404, "order:final_confirm", "ALLOW", "系统管理员可执行最终确认"),
    ("SYS_ADMIN", "/api/tool-io-orders/TEST001/cancel", "POST", 404, "order:cancel", "ALLOW", "系统管理员可取消订单"),
    ("SYS_ADMIN", "/api/tool-io-orders/TEST001", "DELETE", 404, "order:delete", "ALLOW", "系统管理员可删除订单"),

    ("TEAM_LEADER", "/api/orgs", "GET", 200, "dashboard:view", "ALLOW", "班组长可查看组织列表"),
    ("TEAM_LEADER", "/api/tools/search", "GET", 200, "tool:search", "ALLOW", "班组长可搜索工装"),
    ("TEAM_LEADER", "/api/tools/status-history/T000001", "GET", 200, "tool:view", "ALLOW", "班组长可查看工装状态历史"),
    ("TEAM_LEADER", "/api/notifications", "GET", 200, "notification:view", "ALLOW", "班组长可查看通知列表"),
    ("TEAM_LEADER", "/api/tool-io-orders/TEST001/generate-transport-text", "GET", 404, "notification:create", "ALLOW", "班组长可生成运输通知文案"),
    ("TEAM_LEADER", "/api/tool-io-orders/TEST001/notify-transport", "POST", 403, "notification:send_feishu", "DENY", "班组长无权发送飞书通知"),
    ("TEAM_LEADER", "/api/logs", "GET", 404, "log:view", "DENY", "班组长无日志权限且当前路由缺失"),
    ("TEAM_LEADER", "/api/admin/roles", "GET", 403, "admin:role_manage", "DENY", "班组长无权查看角色列表"),
    ("TEAM_LEADER", "/api/admin/users", "GET", 403, "admin:user_manage", "DENY", "班组长无权查看用户列表"),
    ("TEAM_LEADER", "/api/tool-io-orders", "GET", 200, "order:list", "ALLOW", "班组长可查看订单列表"),
    ("TEAM_LEADER", "/api/tool-io-orders", "POST", 400, "order:create", "ALLOW", "班组长通过权限校验后会进入创建参数校验"),
    ("TEAM_LEADER", "/api/tool-io-orders/TEST001/submit", "POST", 404, "order:submit", "ALLOW", "班组长可提交订单"),
    ("TEAM_LEADER", "/api/tool-io-orders/TEST001/keeper-confirm", "POST", 403, "order:keeper_confirm", "DENY", "班组长无权执行保管员确认"),
    ("TEAM_LEADER", "/api/tool-io-orders/TEST001/final-confirm", "POST", 404, "order:final_confirm", "ALLOW", "班组长可执行最终确认"),
    ("TEAM_LEADER", "/api/tool-io-orders/TEST001/cancel", "POST", 404, "order:cancel", "ALLOW", "班组长可取消不存在订单"),
    ("TEAM_LEADER", "/api/tool-io-orders/TEST001", "DELETE", 403, "order:delete", "DENY", "班组长无权删除订单"),

    ("KEEPER", "/api/orgs", "GET", 200, "dashboard:view", "ALLOW", "保管员可查看组织列表"),
    ("KEEPER", "/api/tools/search", "GET", 200, "tool:search", "ALLOW", "保管员可搜索工装"),
    ("KEEPER", "/api/tools/status-history/T000001", "GET", 200, "tool:view", "ALLOW", "保管员可查看工装状态历史"),
    ("KEEPER", "/api/notifications", "GET", 200, "notification:view", "ALLOW", "保管员可查看通知列表"),
    ("KEEPER", "/api/tool-io-orders/TEST001/generate-transport-text", "GET", 404, "notification:create", "ALLOW", "保管员可生成运输通知文案"),
    ("KEEPER", "/api/tool-io-orders/TEST001/notify-transport", "POST", 404, "notification:send_feishu", "ALLOW", "保管员可发送运输通知"),
    ("KEEPER", "/api/logs", "GET", 404, "log:view", "ALLOW", "保管员具备日志查看权限但当前路由缺失"),
    ("KEEPER", "/api/admin/roles", "GET", 403, "admin:role_manage", "DENY", "保管员无权查看角色列表"),
    ("KEEPER", "/api/admin/users", "GET", 403, "admin:user_manage", "DENY", "保管员无权查看用户列表"),
    ("KEEPER", "/api/tool-io-orders", "GET", 200, "order:list", "ALLOW", "保管员可查看订单列表"),
    ("KEEPER", "/api/tool-io-orders", "POST", 403, "order:create", "DENY", "保管员无权创建订单"),
    ("KEEPER", "/api/tool-io-orders/TEST001/submit", "POST", 403, "order:submit", "DENY", "保管员无权提交订单"),
    ("KEEPER", "/api/tool-io-orders/pending-keeper", "GET", 200, "order:keeper_confirm", "ALLOW", "保管员可查看待确认列表"),
    ("KEEPER", "/api/tool-io-orders/TEST001/keeper-confirm", "POST", 400, "order:keeper_confirm", "ALLOW", "保管员可确认订单但空body返回验证错误"),
    ("KEEPER", "/api/tool-io-orders/TEST001/final-confirm", "POST", 404, "order:final_confirm", "ALLOW", "保管员可执行入库最终确认"),
    ("KEEPER", "/api/tool-io-orders/TEST001/cancel", "POST", 404, "order:cancel", "ALLOW", "保管员可取消不存在订单"),
    ("KEEPER", "/api/tool-io-orders/pre-transport", "GET", 403, "order:transport_execute", "DENY", "保管员无权访问预运输列表"),

    ("PRODUCTION_PREP", "/api/orgs", "GET", 200, "dashboard:view", "ALLOW", "运输执行人可查看组织列表"),
    ("PRODUCTION_PREP", "/api/tools/search", "GET", 200, "tool:search", "ALLOW", "运输执行人可搜索工装"),
    ("PRODUCTION_PREP", "/api/tools/status-history/T000001", "GET", 200, "tool:view", "ALLOW", "运输执行人可查看工装状态历史"),
    ("PRODUCTION_PREP", "/api/notifications", "GET", 403, "notification:view", "DENY", "运输执行人无权查看通知"),
    ("PRODUCTION_PREP", "/api/tool-io-orders/TEST001/generate-transport-text", "GET", 403, "notification:create", "DENY", "运输执行人无权生成运输通知文案"),
    ("PRODUCTION_PREP", "/api/tool-io-orders/TEST001/notify-transport", "POST", 403, "notification:send_feishu", "DENY", "运输执行人无权发送飞书通知"),
    ("PRODUCTION_PREP", "/api/logs", "GET", 404, "log:view", "DENY", "运输执行人无日志权限且当前路由缺失"),
    ("PRODUCTION_PREP", "/api/admin/roles", "GET", 403, "admin:role_manage", "DENY", "运输执行人无权查看角色列表"),
    ("PRODUCTION_PREP", "/api/admin/users", "GET", 403, "admin:user_manage", "DENY", "运输执行人无权查看用户列表"),
    ("PRODUCTION_PREP", "/api/tool-io-orders", "GET", 403, "order:list", "DENY", "运输执行人无权查看订单列表"),
    ("PRODUCTION_PREP", "/api/tool-io-orders", "POST", 403, "order:create", "DENY", "运输执行人无权创建订单"),
    ("PRODUCTION_PREP", "/api/tool-io-orders/TEST001/submit", "POST", 403, "order:submit", "DENY", "运输执行人无权提交订单"),
    ("PRODUCTION_PREP", "/api/tool-io-orders/pre-transport", "GET", 200, "order:transport_execute", "ALLOW", "运输执行人可查看预运输列表"),
    ("PRODUCTION_PREP", "/api/tool-io-orders/TEST001/transport-start", "POST", 404, "order:transport_execute", "ALLOW", "运输执行人可启动运输"),
    ("PRODUCTION_PREP", "/api/tool-io-orders/TEST001/keeper-confirm", "POST", 403, "order:keeper_confirm", "DENY", "运输执行人无权执行保管员确认"),
    ("PRODUCTION_PREP", "/api/tool-io-orders/TEST001/final-confirm", "POST", 403, "order:final_confirm", "DENY", "运输执行人无权执行最终确认"),

    ("PLANNER", "/api/orgs", "GET", 200, "dashboard:view", "ALLOW", "计划员应可查看组织列表"),
    ("PLANNER", "/api/tools/search", "GET", 200, "tool:search", "ALLOW", "计划员应可搜索工装"),
    ("PLANNER", "/api/tool-io-orders", "GET", 200, "order:list", "ALLOW", "计划员应可查看订单列表"),
    ("PLANNER", "/api/tool-io-orders", "POST", 400, "order:create", "ALLOW", "计划员应可创建订单"),

    ("AUDITOR", "/api/orgs", "GET", 200, "dashboard:view", "ALLOW", "审计员应可查看组织列表"),
    ("AUDITOR", "/api/notifications", "GET", 200, "notification:view", "ALLOW", "审计员应可查看通知列表"),
    ("AUDITOR", "/api/logs", "GET", 404, "log:view", "ALLOW", "审计员具备日志查看权限但当前路由缺失"),
    ("AUDITOR", "/api/tool-io-orders", "GET", 200, "order:list", "ALLOW", "审计员应可查看订单列表"),
]
