...
| 类型 / Type | 编号范围 / Number Range |
|------------|----------------------|
| Bug Fix / Security Fix | 10101–19999 |
| Refactoring / Tech Debt | 20101–29999 |
| Testing / Quality | 30101–39999 |
| Feature Development | 00001–09999 |
...
2. **判断类型**: 检查任务类型（按编号区间，不按文件名片段）:
   - Bug 提示词: 编号 10101–19999
   - 重构提示词: 编号 20101–29999
   - 测试提示词: 编号 30101–39999
